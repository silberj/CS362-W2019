...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  // int drawntreasure=0; // ** Moved into adventurerTest **
  // int cardDrawn; // ** Moved into adventurerTest **
  // int z = 0;// this is the counter for the temp hand 	** Moved into adventurerTest **
  ...
  switch( card ) 
    ...
    case council_room:
		council_roomTest(state, handPos);
		return 0;
    ...
    case smithy:
		smithyTest(state, handPos);
		return 0;
		
    case village:
		villageTest(state, handPos);
		return 0;
    ...
    case minion:
		minionTest(choice1, choice2, state, handPos);
		return 0;
