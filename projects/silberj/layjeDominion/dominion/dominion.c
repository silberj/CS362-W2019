...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
      ...
      councilRoomEffectBug(currentPlayer, handPos, state);
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
  {
    ...
    case smithy:
      ...
      smithyEffectBug(currentPlayer, handPos, state);
    ...
    case village:
      ...
      villageEffectBug(currentPlayer, handPos, state);
      ...
      else if (choice2)   //discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
  {
    ...
    case steward:
      ...
      stewardEffectBug(choice1, choice2, choice3, 
                        currentPlayer, handPos, state);
...
void adventurerEffectBug(int* drawntreasure, int currentPlayer, struct gameState *state,
                      int temphand[], int* z){
...
void smithyEffectOrig(int currentPlayer, int handPos, struct gameState *state){
...
void smithyEffectBug(int currentPlayer, int handPos, struct gameState *state){
